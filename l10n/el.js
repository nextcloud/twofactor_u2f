OC.L10N.register(
    "twofactor_u2f",
    {
    "Use U2F device" : "Χρήση συσκευής U2F",
    "Server error while trying to add U2F device" : "Σφάλμα του διακομιστή κατά την προσπάθεια προσθήκης συσκευής U2F ",
    "Server error while disabling U2F" : "Σφάλμα διακομιστή κατά την απενεργοποίηση U2F",
    ...
    "U2F second-factor auth" : "Πιστοποίηση δύο βημάτων U2F"
},
