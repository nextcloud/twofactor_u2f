OC.L10N.register(
    ...
    "⚠️ Deprecated ⚠️ Two-Factor U2F" : "⚠️ 已棄用 ⚠️ 雙因子 U2F",
    "U2F two-factor provider (deprecated)" : "U2F 雙重認證供應商 (已棄用)",
    "Deprecated two-factor provider for U2F devices. The Two-Factor WebAuthn provider replaces this app." : "已棄用 U2F 設備的雙因素提供程序。兩因素 WebAuthn 提供程序取代了此應用程式。",
